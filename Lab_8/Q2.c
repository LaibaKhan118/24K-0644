/*Generate a pattern of odd/even numbers in a multi-dimension array of [2][n][2] where the first  [2] is the different arrays for even and odd. The [n] is the amount of array quantity in each odd/even array and the [2] are the two even/odd values in each of them, add them in decreasing order starting from a user-specified number using nested loops.*/
